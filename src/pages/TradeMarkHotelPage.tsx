...
const TradeMarkHotelPage = () => {
  return (
    <>
      <SEOHead
        title="TradeMark Hotel, Nairobi | Creek Oxley DMC"
        description="TradeMark Hotel in Nairobi, Kenya — a premier hospitality property managed by Creek Oxley DMC. Contact us for bookings and partnerships."
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Full property details for TradeMark Hotel are being prepared. Contact our DMC team for more information about this premier destination in Nairobi.
              </p>
            </div>
          </div>
        </section>
