...
const WarwickHotelPage = () => {
  return (
    <>
      <SEOHead
        title="Warwick Hotel, Nanyuki | Creek Oxley DMC"
        description="Warwick Hotel in Nanyuki, Kenya — a distinguished hospitality property managed by Creek Oxley DMC. Contact us for bookings and partnerships."
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Full property details for Warwick Hotel are being prepared. Contact our DMC team for more information about this distinguished property in Nanyuki.
              </p>
            </div>
          </div>
        </section>
