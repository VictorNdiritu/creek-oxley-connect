...
const AboutPage = () => {
  return (
    <>
      <SEOHead
        title="About Creek Oxley | Expert Business Consulting Team"
        description="Learn about Creek Oxley's mission to build strategic sustainable business ecosystems. Meet our expert consulting team specializing in organizational transformation and management solutions."
