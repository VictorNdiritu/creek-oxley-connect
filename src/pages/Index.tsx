...
const Index = () => {
  return (
    <>
      <SEOHead
        title="Creek Oxley | Strategic Business Consulting & Management Solutions"
        description="Transform your business with Creek Oxley's expert consulting services. We provide strategic management solutions, destination management, and smart staffing services in Kenya and beyond."
