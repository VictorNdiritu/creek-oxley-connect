    ...
    <section className="py-16 md:py-24 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Our Connected Brands</h2>
          <p className="text-lg text-gray-600">
            Creek Oxley operates two specialized brands to provide comprehensive solutions in destination management and staffing services.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <Card id="destination-management" className="border-0 shadow-lg overflow-hidden">
            ...
            <CardHeader className="bg-gradient-to-r from-creekoxley/5 to-creekoxley-light/5">
              <CardTitle className="text-2xl font-bold text-creekoxley">Destination Management Company</CardTitle>
            ...
            <CardContent className="pt-6">
              <p className="text-gray-600 mb-4">
                Our Destination Management Company specializes in creating exceptional experiences for corporate events, 
          ...
          <Card id="smart-staffing" className="border-0 shadow-lg overflow-hidden">
            ...
            <CardHeader className="bg-gradient-to-r from-creekoxley-medium/5 to-creekoxley-light/5">
              <CardTitle className="text-2xl font-bold text-creekoxley-medium">Smart Staffing</CardTitle>
              <CardDescription className="text-gray-600 text-lg">
            ...
            <CardContent className="pt-6">
              <p className="text-gray-600 mb-4">
                Smart Staffing delivers innovative human resource solutions to help businesses find the right talent, 
