      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#destination-management" className="text-gray-400 hover:text-white transition-colors">Destination Management</a></li>
              <li><a href="#smart-staffing" className="text-gray-400 hover:text-white transition-colors">Smart Staffing</a></li>
            </ul>
          </div>
